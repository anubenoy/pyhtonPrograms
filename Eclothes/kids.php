...
$products = ["Baby wear blue","levis green","h&M brown"];
$productsPrice = [40.0,50.0,53.0];
$productImages = ["kind1.png","kind2.png","kind3.png"];
...
<head>
    ...
    <script>
        ...
        function addToCart(node, id){
            ...
            window.location.href = "kids.php?id="+id+"&qty="+qty;
        }
    </script>
</head>
<body>
    <nav>
        <div class="navigation_top_user">
            ...
            <div class="rightBar">
                ...
                <a href="kids.php?logout=true">Logout</a>
            </div>
        </div>
    </nav>
    <div class="body-user">
