...
$products = ["us polo T-shirt","levis jeans","levis T-shirt"];
$productsPrice = [20.0,30.0,40.0];
$productImages = ["men1.png","men2.png","men3.png"];
...
<head>
    ...
    <script>
        ...
        function addToCart(node, id){
            ...
            window.location.href = "home.php?id="+id+"&qty="+qty;
        }
    </script>
</head>
<body>
    <nav>
        <div class="navigation_top_user">
            <div class="leftBar">
                <a href="home.php" class="active">Men</a>
